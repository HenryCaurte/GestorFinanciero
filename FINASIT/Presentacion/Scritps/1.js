...
const botonMenu = document.getElementsByClassName('btn');
const opciones = document.getElementById('opciones');

botonMenu[0].addEventListener('click', () => {
    // Cambiar el fondo
    opciones.style.backgroundColor = (opciones.style.backgroundColor === "rgb(36, 37, 37)") ? "#24252500" : "#242525";

    // Cambiar la visibilidad de los enlaces
    var enlaces = opciones.getElementsByTagName('a');
    for (var i = 0; i < enlaces.length; i++) {
        enlaces[i].style.display = (enlaces[i].style.display === 'flex') ? 'none' : 'flex';
    }
});